...
*****
unicode analyze "enaho01b-2021-2.dta"
unicode encoding set ISO-8859-1 //código latino
unicode translate "enaho01b-2021-2.dta"
...
**
keep conglome vivienda hogar ubigeo estrato ocu500 ocusec ocupado independiente formal codperso p507 inghor ramas emp100_500 emp500_mas cat_ocup mas60horas sec_pub
save cap500, replace

***** Educación padre y madre

use "enaho01b-2021-2.dta", clear

** Educacion padres del jefe de hogar
ren p45_1 edu_pa  
replace edu_pa=. if edu_pa==10

ren p45_2 edu_ma
replace edu_ma=. if edu_ma==10

keep conglome vivienda hogar edu_pa edu_ma

save "Cap_1b.dta",replace
...
merge m:1 conglome vivienda hogar using Cap_1b.dta
keep if _merge==3
drop _merge
